 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | LAlt | LGUI |LOWER | /Space  /       \Enter \  |RAISE |BackSP|  KC_RGUI   |
 *                   |      |      |      |/       /         \      \ |      |      |            |
 *                   `----------------------------'           '------''--------------------------'
 */
 ...
 [_QWERTY] = LAYOUT( \
  ...
  KC_LCTRL,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC__MUTE,  KC_BSPC,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_BSLASH, \
...
[_LOWER] = LAYOUT( \
  KC_GRV, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   XXXXXXX, XXXXXXX, XXXXXXX, KC_LBRC, KC_RBRC, XXXXXXX,\
